...
entries = conn.extend.standard.paged_search('OU=Delta,DC=delta,DC=corp', '(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=delta,DC=corp)', paged_size=1000)
size = 0
